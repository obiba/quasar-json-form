...
const en: FormMessages = {
  ...
  builder: {
    ...
    cancel: 'Cancel',
    choices: 'Choices',
    collect: 'Collect the texts',
    collected: '{converted} text(s) made keys, {added} entry(ies) added',
    controls: 'Controls',
    csvImported: '{keys} key(s) read, {values} value(s) set',
    csvInvalid: 'Not a translations CSV',
    data: 'Data',
    ...
    rawKindChanged: 'The type "{type}" would change the kind of the element: add a new element instead',
...
const fr: FormMessages = {
  ...
  builder: {
    ...
    cancel: 'Annuler',
    choices: 'Choix',
    collect: 'Collecter les textes',
    collected: '{converted} texte(s) transformé(s) en clés, {added} entrée(s) ajoutée(s)',
    controls: 'Contrôles',
    csvImported: '{keys} clé(s) lue(s), {values} valeur(s) définie(s)',
    csvInvalid: 'Pas un CSV de traductions',
    data: 'Données',
    diagnostics: 'Diagnostics',
    download: 'Télécharger',
    downloadCsv: 'CSV',
    ...
    rawKindChanged: 'Le type « {type} » changerait la nature de l\'élément : ajoutez plutôt un nouvel élément',
